...
function buildHtml(body, fromName, replyTo) {
  ...
  const replyButton = replyTo ? `
        <tr><td style="padding:20px 40px 0">
          <a href="mailto:${replyTo}" style="display:inline-block;background:#5B6E8F;color:#ffffff;text-decoration:none;padding:11px 24px;border-radius:9px;font-size:13.5px;font-weight:500;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;letter-spacing:-.01em">
            &#9993;&nbsp;&nbsp;Reply to ${fromName.split(' ')[0]}
          </a>
          <p style="font-size:11.5px;color:#A09C96;margin:8px 0 0;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif">Replies go directly to ${replyTo}</p>
        </td></tr>` : '';
